...
export class DOMCache {
    ...
    cacheAll(): DOMElements {
        ...
        this.#cache = {
            ...
            showSectorChartBtn: D.getElementById('showSectorChartBtn'),
            ...
            sectorChartContainer: D.getElementById('sectorChartContainer'),
            sectorChart: D.getElementById('sectorChart'),
            allocationChartContainer: D.getElementById('allocationChartContainer'),
            allocationChart: D.getElementById('allocationChart'),
            dailyReturnChartContainer: D.getElementById('dailyReturnChartContainer'),
